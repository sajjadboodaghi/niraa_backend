...
$selectQuery = "SELECT * FROM items WHERE `timestamp` < :last_timestamp AND subcat_id = :subcat_id AND place LIKE :city AND image_count >= :image_count AND verified = 1 ORDER BY `timestamp` DESC LIMIT :items_count";
