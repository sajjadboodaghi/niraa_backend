            ...
            if(!hasWaitingItem($conn, $phoneNumber)) {
                if(isset($_POST['title']) && isset($_POST['description'])) {
                    ...
                    if(trim($title, ' ') != "" && trim($description, ' ') != "") {
                        ...
                        $insertQuery = 'INSERT INTO `items`(`phone_number`, `title`, `description`, `price`, `place`, `subcat_name`, `subcat_id`, `shamsi`, `timestamp`, `image_count`) VALUES (:phone_number, :title, :description, :price, :place, :subcat_name, :subcat_id, :shamsi, :timestamp, :image_count);';
                ...
                $response['message'] = 'زمانی که آگهی تأیید نشده دارید، نمی‌توانید آگهی جدید ثبت کنید!';
            }
        } else {
            $response['error'] = true;
